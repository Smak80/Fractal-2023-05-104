...
object VideoMakerHelper{
    ...
    fun blendFrames(frame1: Plane, frame2: Plane, alpha: Double,width:Int,height:Int): BufferedImage {
        ...
        val blendedFrame = Cadre.getImageFromPlane(plane,width.toFloat(),height.toFloat(),ColorFuncs.First)

        return blendedFrame
    }

    fun interpolate(value1: Double, value2: Double, alpha: Double): Double {
